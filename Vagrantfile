...
vm_shared_folder = "/home/#{linux_user}/shared"

# Git credentials and paths
git_host="github.com"
git_user_full_name="James Summerill"
git_user_email="shoutsid@gmail.com"
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision :reload
	...
	# Install Vim to be as local environment. this is run as the ubuntu USER because
	# the script uses the home directory for user specific dot files
	config.vm.provision "shell",
    path: "#{host_shared_folder}/vm_provisioning/setup_vim.sh",
    privileged: false
